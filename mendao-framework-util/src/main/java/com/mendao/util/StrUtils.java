...
public class StrUtils {
	...
	public static String[] splitAndTrim(String str, String sep, String sep2) {
		...
		if (!StringUtil.isBlank(sep2)) {
			str = StringUtil.replace(str, sep2, sep);
		}
		String[] arr = StringUtil.split(str, sep);
		// trim
...
//		}
	...
	public static boolean contains(String str, String search) {
		if (StringUtil.isBlank(str) || StringUtil.isBlank(search)) {
			return false;
		}
		String reg = StringUtil.replace(search, "*", ".*");
